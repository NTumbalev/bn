...
namespace NT\LocationsBundle\Admin;
        ...
        $formMapper
            ->with('tab.general', array(
                ...
                ->with('form.general', array(
                        'class' => 'col-md-12',
                        'label' => 'form.general',
                        'translation_domain' => 'NTLocationsBundle',
                    )
                )
            ...
            ->with('Publish Workflow', array('tab' => true))
                ->with('Publish Workflow', array('class' => 'col-md-12', 'label' => 'form.general', 'translation_domain' => 'NTLocationsBundle'))
